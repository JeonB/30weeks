...
/* Promise.all 하나라도 실패하면 모두 실패 */
const p4 = Promise.resolve('OK');
const p5 = Promise.reject('Error!');
const p6 = Promise.resolve('Fine');

Promise.all([p4, p5, p6]).then(console.log).catch(console.error); // 'Error!' 출력
